...
class ChatMetaLlamaLoader(BaseLoader):
    ...
    """
    ChatMetaLlama document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import ChatMetaLlamaLoader

            loader = ChatMetaLlamaLoader(
                # required params = ...
                # other params = ...
            )
