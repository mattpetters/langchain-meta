...
class ChatMetaLlamaToolInput(BaseModel):
    """Input schema for ChatMetaLlama tool.
...
class ChatMetaLlamaTool(BaseTool):  # type: ignore[override]
    """ChatMetaLlama tool.
    ...
    args_schema: Type[BaseModel] = ChatMetaLlamaToolInput
