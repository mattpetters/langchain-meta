...
class ChatMetaLlamaRetriever(BaseRetriever):
    ...
    """ChatMetaLlama retriever.

    # TODO: Replace with relevant packages, env vars, etc.
    Setup:
        Install ``langchain-meta`` and set environment variable
        ``META_API_KEY``.
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-meta import ChatMetaLlamaRetriever

            retriever = ChatMetaLlamaRetriever(
                # ...
            )
