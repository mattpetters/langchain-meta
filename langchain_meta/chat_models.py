...
class ChatMetaLlama(BaseChatModel):
    ...
    """ChatMetaLlama chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-meta`` and set environment variable ``META_API_KEY``.
    ...
    Key init args — completion params:
        model: str
            Name of ChatMetaLlama model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            ChatMetaLlama API key. If not passed in will be read from env var META_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatChatMetaLlama.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatChatMetaLlama.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatChatMetaLlama supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatChatMetaLlama supports async generation. Otherwise delete.
