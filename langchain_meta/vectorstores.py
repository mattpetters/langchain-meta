...
class ChatMetaLlamaVectorStore(VectorStore):
    # TODO: Replace all TODOs in docstring.
    """ChatMetaLlama vector store integration.
    ...
    Instantiate:
        .. code-block:: python
            ...
            vector_store = ChatMetaLlamaVectorStore(
                collection_name="foo",
    ...
    @classmethod
    def from_texts(
        cls: Type[ChatMetaLlamaVectorStore],
        texts: List[str],
