...
class ChatMetaLlamaToolkit(BaseToolkit):
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain-meta import ChatMetaLlamaToolkit

            toolkit = ChatMetaLlamaToolkit(
                # ...
            )
